...
*/
#define LCD_LAYER0_FRAME_BUFFER  LCD_FRAME_BUF_ADDR
...
void LCD_X_Config(void) 
{
	...
	LCD_SetVSizeEx(0, lcddev.width, lcddev.height * NUM_VSCREENS);
	#if (GUI_NUM_LAYERS > 1)
		//
		...
		//
		LCD_SetSizeEx (1, lcddev.width, lcddev.height);
		LCD_SetVSizeEx(1, lcddev.width, lcddev.height * NUM_VSCREENS);
	#endif
